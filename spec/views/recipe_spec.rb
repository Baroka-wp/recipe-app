...
RSpec.describe Recipe, type: :view do
    before :each do
        ...
        @recipe = Recipe.create(name: "macaro", description: "Itelian", prep_time: 10, cooking_time: 10, public: false, user_id: @user.id)
        @recipe = Recipe.create(name: "rita", description: "french", prep_time: 10, cooking_time: 10, user_id: @user1.id)
    end
